								...
								<form method="post">
									...
									while ($row = mysqli_fetch_array($ret)) {
										...
										<div class="form-group"> <label for="exampleInputEmail1">Page Title</label> <input
												...
												value="<?php echo $row['PageTitle']; ?>" required="true"> </div>
										...
										<div class="form-group"> <label for="exampleInputEmail1">Timing</label> <input
												type="text" class="form-control" name="timing" id="timing"
												value="<?php echo $row['Timing']; ?>" required="true"> </div>
